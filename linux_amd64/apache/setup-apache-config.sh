#!/usr/bin/env bash
# Script to update Apache configuration with correct paths for Linux (amd64)
...
echo "Apache CGI Setup for OpenEMR (Linux amd64)"
echo "=============================="
...
if [ -z "${PHP_CGI}" ]; then
    echo "Warning: PHP CGI binary not found at ${LINUX_DIR}/php-cgi-*-linux-amd64"
